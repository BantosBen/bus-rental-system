                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3 mt-lg-3" id="rating-form">
                            ...
                            <input type="hidden" name="bus_id" value="<?php echo $reservation['bus_id']; ?>">
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="comment" class="form-control" id="floatingBusName"
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="ratings" class="form-control" value="5"
                                        id="floatingBusName" placeholder="Enter your ratings max 10">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="complete-reservation" class="btn btn-primary">Complete
                            Reservation</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="row justify-content-center">
                            <div class="col-md-8 d-flex justify-content-center">
                                ...
                                <p class="mt-2 mx-2">Working on your request. Please wait...</p>
                            </div>
                        </div>
                    </div>
                </div>
