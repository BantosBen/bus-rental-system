<?php require_once('controller/driver.php') ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                   ...
                   with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <a href="drivers.php" class="nav-link active">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($mDriver['status'] == 'unavailable') { ?>
                        ...
                        <div class="modal-body row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="license_number" class="form-control"
                                        id="license_number" placeholder="Enter License Number">
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
                    ...
                    <form method="post" action="">
                        ...
                        <div class="modal-body row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="first_name">First Name</label>
                                    <input value="<?php echo $mDriver['first_name'] ?>" required type="text"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="last_name">Last Name</label>
                                    <input value="<?php echo $mDriver['last_name'] ?>" required type="text"
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input value="<?php echo $mDriver['email_address'] ?>" required type="email"
                                        name="email" class="form-control" id="email" placeholder="Enter Email Address">
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="phone">Phone Number</label>
                                    <input value="<?php echo $mDriver['phone_number'] ?>" required type="number"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="license_number">Year</label>
                                    <input value="<?php echo $mDriver['license_number'] ?>" required type="text"
                                        name="license_number" class="form-control" id="license_number"
